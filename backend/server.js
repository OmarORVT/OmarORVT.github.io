...
const chemistryKnowledge = {
  ...
  "particulas subatomicas": "Las principales partículas subatómicas son protones (carga positiva), neutrones (sin carga) y electrones (carga negativa). Los protones y neutrones están en el núcleo.",
  "nucleo atomico": "Región central del átomo donde se concentra casi toda la masa. Contiene protones y neutrones unidos por fuerzas nucleares fuertes.",
  "radiactividad": "Fenómeno por el cual núcleos inestables se desintegran espontáneamente emitiendo partículas alfa, beta o radiación gamma. Descubierta por Becquerel.",
  "decaimiento alfa": "Tipo de desintegración radiactiva donde el núcleo emite una partícula alfa (núcleo de helio: 2 protones + 2 neutrones).",
  "decaimiento beta": "Desintegración donde se emite un electrón (β-) o positrón (β+). En β-, un neutrón se convierte en protón.",
  "radiacion gamma": "Radiación electromagnética de alta energía emitida por núcleos excitados. Acompaña otros tipos de desintegración.",
  "modelo de bohr sommerfeld": "Extensión del modelo de Bohr que introduce órbitas elípticas y números cuánticos adicionales.",
  "radiacion cuerpo negro": "Radiación electromagnética emitida por un cuerpo que absorbe toda la radiación incidente. Planck explicó su espectro.",
  "teoria de planck": "Planck propuso que la energía se emite en cuantos discretos (E=hf), resolviendo el problema del ultravioleta catastrófico.",
  "numero cuantico principal": "Número cuántico n que indica el nivel de energía principal del electrón. Determina el tamaño del orbital.",
  "numero cuantico azimutal": "Número cuántico l que describe la forma del orbital. l=0(s), l=1(p), l=2(d), l=3(f).",
  "numero cuantico magnetico": "Número cuántico ml que describe la orientación espacial del orbital. Valores de -l a +l.",
  "numero cuantico de espin": "Número cuántico ms que describe el espín del electrón. Valores +1/2 o -1/2.",
  "orbitales s": "Orbitales esféricos centrados en el núcleo. Cada nivel tiene un orbital s que puede contener máximo 2 electrones.",
  "orbitales p": "Orbitales con forma bilobular. Hay 3 orbitales p por nivel (px, py, pz) orientados perpendicularmente.",
  "orbitales d": "Orbitales de formas complejas. Hay 5 orbitales d por nivel que pueden contener hasta 10 electrones.",
  "orbitales f": "Orbitales de formas muy complejas. Hay 7 orbitales f por nivel que pueden contener hasta 14 electrones.",
  "principio de exclusion de pauli": "Ningún electrón en un átomo puede tener los mismos cuatro números cuánticos.",
  "regla de hund": "Los electrones ocupan orbitales degenerados individualmente con espines paralelos antes de emparejarse.",
  "electrones de valencia": "Electrones en la capa más externa del átomo. Determinan las propiedades químicas y la capacidad de formar enlaces.",
  "familias": "Otro nombre para los grupos de la tabla periódica. Elementos de la misma familia tienen configuraciones electrónicas similares.",
  "bloques": "Divisiones de la tabla periódica según el último orbital ocupado: bloque s, p, d, f.",
  "metales alcalinos": "Elementos del grupo 1: Li, Na, K, Rb, Cs, Fr. Tienen un electrón de valencia, son muy reactivos.",
  "metales alcalinoterreos": "Elementos del grupo 2: Be, Mg, Ca, Sr, Ba, Ra. Tienen dos electrones de valencia, forman iones +2.",
  "halogenos": "Elementos del grupo 17: F, Cl, Br, I, At. Tienen 7 electrones de valencia, muy reactivos, forman iones -1.",
  "gases nobles": "Elementos del grupo 18: He, Ne, Ar, Kr, Xe, Rn. Tienen configuración electrónica completa, químicamente inertes.",
  "metales de transicion": "Elementos de los grupos 3-12. Tienen orbitales d parcialmente llenos, forman iones coloreados.",
  "lantanidos": "Serie de 14 elementos desde La hasta Lu. Tienen orbitales f parcialmente llenos, propiedades muy similares.",
  "actinidos": "Serie de 14 elementos desde Ac hasta Lr. Todos son radiactivos, muchos son sintéticos.",
  "elementos representativos": "Elementos de los grupos 1, 2 y 13-18. Sus propiedades se predicen bien por su posición en la tabla.",
  "propiedades periodicas": "Propiedades que varían de manera predecible: radio atómico, energía de ionización, electronegatividad.",
  "radio covalente": "Mitad de la distancia entre núcleos de dos átomos idénticos unidos covalentemente.",
  "primera energia de ionizacion": "Energía para remover el primer electrón. Varía periódicamente y es menor para metales alcalinos.",
  "segunda energia de ionizacion": "Energía para remover el segundo electrón. Siempre mayor que la primera.",
  "carga nuclear efectiva": "Carga positiva neta que experimenta un electrón, considerando el apantallamiento de otros electrones.",
  "efecto pantalla": "Reducción de la atracción nuclear sobre electrones externos debido a la repulsión de electrones internos.",
  "enlace covalente polar": "Enlace covalente donde los electrones se comparten desigualmente debido a diferencias de electronegatividad.",
  "enlace covalente no polar": "Enlace covalente donde los electrones se comparten igualmente entre átomos de igual electronegatividad.",
  ...
  "cambios de estado": "Transiciones entre estados de la materia: fusión, solidificación, vaporización, condensación, sublimación.",
  ...
  "balanceo de ecuaciones": "Proceso de ajustar coeficientes en una ecuación química para que se cumpla la ley de conservación de la masa.",
  "coeficientes estequiometricos": "Números que preceden las fórmulas en una ecuación balanceada. Indican las proporciones molares.",
  ...
  "grupo funcional": "Átomo o grupo de átomos que confiere propiedades químicas características a los compuestos orgánicos.",
